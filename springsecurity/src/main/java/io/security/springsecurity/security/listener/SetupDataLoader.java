...
import io.security.springsecurity.domain.entity.*;
import io.security.springsecurity.repository.*;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void setupSecurityResources() {
        ...
        createResourceIfNotFound("io.security.springsecurity.aopsecurity.method.AopMethodService.methodTest", "", roles1, "method");
        createResourceIfNotFound("io.security.springsecurity.aopsecurity.method.AopMethodService.innerCallMethodTest", "", roles1, "method");
        createResourceIfNotFound("execution(* io.security.springsecurity.aopsecurity.pointcut.*Service.*(..))", "", roles1, "pointcut");
